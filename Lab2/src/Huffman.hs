...
main :: IO ()
main = do
    contents <- readFile "/Users/flystyle/Documents/7 sem/Lisp_Haskell/Lab2/file.txt"
    contents2 <- readFile "/Users/flystyle/Documents/7 sem/Lisp_Haskell/Lab2/file2.txt"
    contents3 <- readFile "/Users/flystyle/Documents/7 sem/Lisp_Haskell/Lab2/file3.txt"

    let l = lines contents ++ contents2 ++ contents3
