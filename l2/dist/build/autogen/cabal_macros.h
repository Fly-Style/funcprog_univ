...
/* package l2-0.1.0.0 */
#define VERSION_l2 "0.1.0.0"
#define MIN_VERSION_l2(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define VERSION_binary_strict "0.4.8.3"
...
#define CURRENT_COMPONENT_ID "l2-0.1.0.0"

#define CURRENT_PACKAGE_KEY "l2-0.1.0.0"
